...
class DecompositionRepository:
    ...
    def decomposition_exists(self, tool, application, partition_count, granularity, variant="default", filtered=True):
        import os
        path = self.get_decomposition_path(tool, application, partition_count, granularity, variant, filtered)
