...
class VisualizationGenerator:
    ...
    def copy_visualization(self, app, tool, granularity="class", p_count="n", variant="default"):
        ...
        if tool == "ground_truth":
            ...
            tool_name = "9_mosaic"
        elif tool == "tomicroservices_p1":
            tool_name = "10_tomicroservices_p1"
        elif tool == "tomicroservices_p2":
            tool_name = "11_tomicroservices_p2"
        elif tool == "tomicroservices_p3":
            tool_name = "12_tomicroservices_p3"
        else:
            tool_name = "unknown"
        output_path = (
                ...
                for partition in self.manifest.get_partition_count_options(
                    ...
                    for decomposition_type in self.manifest.get_decomposition_variants(
                        ...
                        for granularity in granularities:
                            # Skip if decomposition doesn't exist
                            if not self.decomposition_repository.decomposition_exists(
                                tool=tool,
