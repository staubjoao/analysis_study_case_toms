class DecompositionIdentifier:
    def __init__(self, application: str, tool: str, partition_count: str, variant: str, granularity: str):
        ...
        if tool not in ["cargo", "datacentric", "ground_truth", "hydec", "log2ms", "mono2micro", "tomicroservices", "tomicroservices_p1", "tomicroservices_p2", "tomicroservices_p3", "mosaic", "mem"]:
